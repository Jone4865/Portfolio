...
export const lightTheme: AppTheme = {
  ...
  siderGradient: `
    radial-gradient(360px 280px at 15% 5%, rgba(184, 50, 83, 0.13), transparent 68%),
    radial-gradient(320px 360px at 100% 72%, rgba(59, 130, 246, 0.09), transparent 72%),
    linear-gradient(160deg, rgba(255, 252, 249, 0.98) 0%, rgba(244, 237, 232, 0.96) 100%)
  `,
...
export const darkTheme: AppTheme = {
  ...
  siderGradient: 'rgba(18, 20, 28, 0.92)',
