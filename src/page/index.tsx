  ...
  const [project] = useState<Data[]>([
    {
      ...
      experience: [
        ...
        '웹·API 패키지 분리 빌드·실행 체계 정립 → 모노레포 개발·배포 작업 흐름 표준화',
      ],
      people: '개발 3',
      stack: [
    ...
    },
    {
      ...
      experience: [
        ...
        '정산 목록/필터/정렬/엑셀 다운로드 UX 개선 및 성능 튜닝 → 대용량 데이터 환경에서도 빠른 조회',
        '영업·유지보수 업무 유형별 정산 체계 분리 → 조회·관리 흐름 일관성 확보',
        '거래처/파트너 경로 표시 규칙 정리 → 화면에서 직관적인 정보 확인 가능',
        '운영 데이터 불일치/중복 이슈 추적 → 원인-수정-배포 신속 처리',
        '정산·리포트·대시보드 데이터 표준화 → 화면 간 표시 일관성 확보',
      ],
      people: '개발 3',
      stack: [
        { name: 'Vue 3', icon: <SiVuedotjs /> },
